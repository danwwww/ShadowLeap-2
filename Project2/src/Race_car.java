...
public class Race_car extends Sprite{
	private boolean moveRight;
	private static final float Speed=0.5f;
	//construct the bus with allocated picture
	private static final String RACE_PATH = "assets/racecar.png";
	public Race_car(float x, float y,boolean moveR) throws SlickException {
		super(RACE_PATH,"Race_car",x,y);
